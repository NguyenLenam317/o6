      ...
      <CardContent className="p-6">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="text-center md:text-left md:mr-6 mb-4 md:mb-0">
            ...
            <p className="text-neutral-500 overflow-hidden overflow-wrap-break-word max-w-full">{data.current.weatherDescription}</p>
          ...
          <div className="grid grid-cols-2 gap-x-8 gap-y-3 flex-grow">
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-neutral-500 overflow-hidden text-ellipsis whitespace-nowrap">Humidity</p>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-neutral-500 overflow-hidden text-ellipsis whitespace-nowrap">Wind</p>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-neutral-500 overflow-hidden text-ellipsis whitespace-nowrap">Pressure</p>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm text-neutral-500 overflow-hidden text-ellipsis whitespace-nowrap">Visibility</p>
        ...
        <div className="mt-6">
          <h4 className="text-sm font-medium text-neutral-600 mb-3 overflow-hidden text-ellipsis whitespace-nowrap">Today's Forecast</h4>
                  ...
                  if (hour >= nextHour || time.getDate() > new Date().getDate()) {
                    ...
                    hourlyItems.push(
                      <div key={timeStr} className="flex flex-col items-center mx-auto min-w-[60px] px-2">
                        <p className="text-sm text-neutral-500 overflow-hidden text-ellipsis whitespace-nowrap w-full text-center">{displayHour}</p>
                        <span className="material-icons text-lg my-2">{icon}</span>
                        <p className="text-sm font-medium overflow-hidden text-ellipsis whitespace-nowrap w-full text-center">{temp}°C</p>
                      </div>
                    );
