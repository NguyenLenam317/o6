        ...
        <Tabs defaultValue="current" value={activeTab} onValueChange={setActiveTab} className="mb-8">
          ...
          <TabsContent value="forecast" className="space-y-6">
            {forecastLoading ? (
              ...
              <>
                <Card>
                  <CardHeader>
                    <CardTitle className="overflow-hidden text-ellipsis whitespace-nowrap">7-Day Temperature Forecast</CardTitle>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <Card>
                    <CardHeader>
                      <CardTitle className="overflow-hidden text-ellipsis whitespace-nowrap">Precipitation Forecast</CardTitle>
                      <CardDescription className="overflow-hidden text-ellipsis whitespace-nowrap">Expected precipitation in mm</CardDescription>
                    </CardHeader>
                    <CardContent>
                      <ResponsiveBarChart
                        data={(forecastData.daily?.time || []).map((date: string, i: number) => {
                  ...
                  <Card>
                    <CardHeader>
                      <CardTitle className="overflow-hidden text-ellipsis whitespace-nowrap">Weather Conditions</CardTitle>
                      <CardDescription className="overflow-hidden text-ellipsis whitespace-nowrap">Daily weather conditions and wind speed</CardDescription>
                    </CardHeader>
                    <CardContent className="p-6">
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                        {(forecastData.daily?.time || []).map((date: string, i: number) => {
                          ...
                          return (
                            <div key={date} className="flex flex-col items-center p-3 bg-gray-50 rounded-lg overflow-hidden">
                              <p className="text-sm font-medium overflow-hidden text-ellipsis whitespace-nowrap w-full text-center">{day}</p>
                              <span className="material-icons text-2xl my-2">{weatherIcon}</span>
                              <div className="flex items-center">
                                <span className="material-icons text-sm mr-1">air</span>
                                <span className="text-xs overflow-hidden text-ellipsis whitespace-nowrap">{windSpeed} km/h</span>
                              </div>
                            </div>
                          );
                        })}
          ...
          <TabsContent value="historical" className="space-y-6">
            {historicalLoading ? (
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="overflow-hidden text-ellipsis whitespace-nowrap">Historical Weather Data</CardTitle>
                  <CardDescription className="overflow-hidden text-ellipsis whitespace-nowrap">Temperature and precipitation for the past 30 days</CardDescription>
                </CardHeader>
                <CardContent>
                  <ResponsiveLineChart
